...
&emsp; We can consider modular forms as homogeneous functions $$ F \colon \CL \to \CC $$ on complex lattices of degree $$ -k $$. Here, $$ \CL $$ is the free abelian group generated by complex lattices $$ \ZZ[a, b] $$ with $$ a, b \in \CC $$; and homogeneity means for $$ \lambda \in \CC^{\times} $$
