...
&emsp; We can consider modular forms as homogenious functions on complex lattices of degree $$ -k $$. Write $$ \ZZ[a, b] $$ for a complex lattice generated by $$ a, b \in \CC $$. Then for $$ f $$ a modular form of weight $$ k $$, we get our desired function on complex lattices by $$ F(a, b) = b^{-k} F(a/b) $$. Likewise, given such an $$ F $$, we see that $$ f(z) = F(z, 1) $$ is a modular form.
