...
<ol type="a" class="custom" style="list-style-position: outside">
  ...
  <li>\( f(z) \) remains bounded as \( \im(z) \) approaches infinity.</li>
</ol>
...
This is equivalent to $$ f $$ having constant term 0 in its $$ q $$ expansion at infinity. We denote the space of modular forms of weight $$ k $$ by $$ M_k $$, and of cusp forms by $$ S_k $$.
...
&emsp; In order to resolve the problem of $$ M_n $$ not being a smooth projective variety, Deligne uses some machinary which we will not discuss here. With a bit of proof, this allows us to apply the Riemann hypothesis to get the following:
